<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditZy.aspx.cs" Inherits="Student_EditZy" %>
            ...
            <tr>
              <td bgcolor="#cfe3fe" valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" height="55" width="696">
                        <tr>
                          <td><div align="center" class="STYLE1">管理我的作业</div></td>
                        </tr>
                    </table>
                        ...
                        <td height="54" valign="top">
                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" BackColor="White"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="Zm_KcTitle" HeaderText="课程名"></asp:BoundColumn>
                                    <asp:BoundColumn DataField="Zm_Title" HeaderText="作业题目"></asp:BoundColumn>
                                    <asp:HyperLinkColumn DataNavigateUrlField="Zm_File" DataNavigateUrlFormatString="../UpLoad/{0}"
                                        HeaderText="作业" Target="_blank" Text="下载">
