<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditNotes.aspx.cs" Inherits="Admin_EditKc" %>
                      ...
                      <td height="54" valign="top">
                          <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" BackColor="White"
                              ...
                              <Columns>
                                  ...
                                  <asp:BoundColumn DataField="No_Name" HeaderText="姓名"></asp:BoundColumn>
                                  <asp:BoundColumn DataField="No_Email" HeaderText="Email">
                                      <HeaderStyle Width="100px" />
                                  </asp:BoundColumn>
                                  <asp:BoundColumn DataField="No_Zt" HeaderText="状态"></asp:BoundColumn>
                                  <asp:HyperLinkColumn DataNavigateUrlField="No_ID" DataNavigateUrlFormatString="ToNote.aspx?ID={0}"
                                      HeaderText="回复" Text="回复"></asp:HyperLinkColumn>
                                  <asp:TemplateColumn>
