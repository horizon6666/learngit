<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditNews.aspx.cs" Inherits="Teacher_EditNews" %>
                      ...
                      <tr>
                        <td height="54" valign="top">
                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" BackColor="White"
                                ...
                                <Columns>
                                    <asp:BoundColumn DataField="Ne_ID" HeaderText="ID">
                                        <HeaderStyle Width="50px" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Ne_Title" HeaderText="标题"></asp:BoundColumn>
                                    <asp:BoundColumn DataField="Ne_TeName" HeaderText="发布人"></asp:BoundColumn>
                                    <asp:BoundColumn DataField="Ne_AddDate" HeaderText="发布日期">
