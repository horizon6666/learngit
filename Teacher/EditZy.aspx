<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditZy.aspx.cs" Inherits="Teacher_EditZy" %>
                      ...
                      <tr>
                        <td height="54" valign="top">
                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" BackColor="White"
                                ...
                                <Columns>
                                    <asp:BoundColumn DataField="Zy_ID" HeaderText="ID">
                                        <HeaderStyle Width="50px" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Zy_KcName" HeaderText="所属课程"></asp:BoundColumn>
                                    <asp:BoundColumn DataField="Zy_Title" HeaderText="作业名称"></asp:BoundColumn>
                                    <asp:BoundColumn DataField="Zy_TeName" HeaderText="发布人">
                                        <HeaderStyle Width="50px" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Zy_AddDate" HeaderText="发布日期">
                                        <HeaderStyle Width="60px" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Zy_ToDate" HeaderText="提交日期">
                                        <HeaderStyle Width="60px" />
                                    </asp:BoundColumn>
                                    <asp:TemplateColumn>
                                        <HeaderTemplate>
