                  ...
                  <tr>
                      <td height="54" valign="top">
                          <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" BackColor="White"
                              ...
                              <Columns>
                                  <asp:BoundColumn DataField="Te_ID" HeaderText="ID">
                                      <HeaderStyle Width="50px" />
                                  </asp:BoundColumn>
                                  <asp:BoundColumn DataField="Te_Uid" HeaderText="帐号"></asp:BoundColumn>
                                  <asp:BoundColumn DataField="Te_Name" HeaderText="姓名">
                                      <HeaderStyle Width="100px" />
                                  </asp:BoundColumn>
                                  <asp:BoundColumn DataField="Te_Sex" HeaderText="性别"></asp:BoundColumn>
                                  <asp:BoundColumn DataField="Te_Zhicheng" HeaderText="职称"></asp:BoundColumn>
                                  <asp:BoundColumn DataField="Te_Hone" HeaderText="电话"></asp:BoundColumn>
                                  <asp:TemplateColumn>
