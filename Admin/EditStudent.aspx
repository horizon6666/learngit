            ...
            <tr>
              ...
              <table align="center" border="0" cellpadding="0" cellspacing="0" width="686">
                  <tr>
                      <td height="54" valign="top">
                          <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" BackColor="White"
                              ...
                              <Columns>
                                  <asp:BoundColumn DataField="Us_ID" HeaderText="ID">
                                      <HeaderStyle Width="50px" />
                                  </asp:BoundColumn>
                                  <asp:BoundColumn DataField="Us_Uid" HeaderText="帐号"></asp:BoundColumn>
                                  <asp:BoundColumn DataField="Us_Name" HeaderText="姓名">
                                      <HeaderStyle Width="100px" />
                                  </asp:BoundColumn>
                                  <asp:BoundColumn DataField="Us_Sex" HeaderText="性别"></asp:BoundColumn>
                                  <asp:BoundColumn DataField="Us_Banji" HeaderText="班级"></asp:BoundColumn>
                                  <asp:BoundColumn DataField="Us_Hone" HeaderText="电话"></asp:BoundColumn>
                                  <asp:BoundColumn DataField="Us_YesNo" HeaderText="认证"></asp:BoundColumn>
                                  <asp:TemplateColumn>
                  ...
                  <tr>
                      <td height="30">
                          <div align="left">
                              <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" Text="删除所选信息" />
                              &nbsp; &nbsp;
                              <asp:Button ID="btnRenzheng" runat="server" OnClick="btnRenzheng_Click" Text="认证所选信息" /></div>
                      </td>
                  </tr>
              </table>
          </td>
